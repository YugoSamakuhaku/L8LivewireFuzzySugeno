...
class Stockreport extends Component
{
    ...
    public function load_datatable($date_start, $date_end)
    {
        ...
        $inggridientHistory = InggridientHistory::with('master_inggridients:id_inggridient,name_inggridient,unit_inggridient')->whereBetween('date', [$this->date_start,  $this->date_end])->get();

        foreach ($inggridientHistory as $key => $value) {
            $this->stock_report[] = [
                'id_inggridient' => $value->id_inggridient,
                'name_inggridient' => $value->master_inggridients->name_inggridient,
                'unit_inggridient' => $value->master_inggridients->unit_inggridient,
                'date' => $value->date,
                'stock' => $value->stock,
