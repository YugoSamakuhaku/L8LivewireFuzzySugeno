@section('title', 'Create Data Inggridient')
<div>
    <div>
        <!-- Site wrapper -->
        <div class="wrapper">
                        ...
                        <div class="card-body pt-4">
                            <form wire:submit.prevent="submit">
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        class="form-control @error('master_inggridient.name_inggridient') is-invalid @enderror"
                                        id="name_inggridient" placeholder="Enter Name Inggridient"
                                        wire:model.defer="master_inggridient.name_inggridient">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number"
                                        class="form-control @error('master_inggridient.price_inggridient') is-invalid @enderror"
                                        id="price_inggridient" placeholder="Enter Name Inggridient"
                                        wire:model.defer="master_inggridient.price_inggridient">
