                    ...
                    <div class="card">
                        ...
                        <div class="card-body pt-4">
                            <div class="row">
                                ...
                                <div class="form-group col">
                                    <input type="number" class="form-control @error('qty') is-invalid @enderror" id="qty" placeholder="Enter Qty" wire:model.defer="qty">
                                    @error('qty')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="form-group col">
                                    <a wire:click="add_product" class="btn btn-primary">Add Product to cart</a>
                                </div>
                            </div>
